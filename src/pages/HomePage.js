...
export default function HomePage({ onAddMeal, mealCount }) {
  ...
  return (
    <div className="relative z-10 max-w-2xl mx-auto px-4 md:py-4 animate-fade-in w-full">
      {/* Hero Section */}
      <div className="glass-strong p-5 md:p-8 text-center mb-3 md:mb-4 shadow-xl shadow-rose-200/30">
        <div className="text-3xl md:text-6xl mb-2 md:mb-3 animate-heart-beat">🫀</div>
        <h1 className="font-cursive text-2xl md:text-5xl bg-gradient-to-r from-rose-500 via-pink-500 to-rose-400 bg-clip-text text-transparent mb-2 md:mb-3 leading-tight">
          Hey love Sriii <IoMdHeartEmpty className="inline text-rose-400 animate-pulse" />
        </h1>
        <p className="text-rose-500 text-base md:text-xl font-semibold mb-2 md:mb-2">
          Em tinnav iroju ?
        </p>
        ...
        {/* Meal Count Summary */}
        {mealCount > 0 && (
          <div className="mt-3 md:mt-4 glass-card inline-block px-3 py-1.5 md:px-6 md:py-3">
